...
# read in data
df = pd.read_csv(r'C:\Users\kaybr\Downloads\athlete_events.csv')
region_df = pd.read_csv(r'C:\Users\kaybr\Downloads\noc_regions.csv')
...
if user_menu == 'Medal Tally':
    ...
    if selected_year != 'Overall' and selected_country != 'Overall':
        st.header('Medal Tally for '+ selected_country + ' in ' + str(selected_year))
    st.table(medal_tally)

 # Overall Analysis Setup
...
if user_menu == 'Country-wise Analysis':
    ...
    temp_df = helper.most_sucessful_countrywise(df, selected_country)
    st.table(temp_df)


# Athlete Analysis Setup
